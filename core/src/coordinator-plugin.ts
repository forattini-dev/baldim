...
import type { GlobalCoordinatorService, LeaderChangeEvent } from './plugins/concerns/global-coordinator-service.class.js';

let workerCounter = 0;

export interface CoordinatorConfig extends PluginOptions {
...
export type { LeaderChangeEvent } from './plugins/concerns/global-coordinator-service.class.js';
