...
describe('GraphPlugin', () => {
  ...
  beforeAll(async () => {
    ...
    db = new Database({ connectionString: 'memory://test/graph-db', logLevel: 'silent' });
    await db.connect();
  ...
  describe('Plugin Installation', () => {
    ...
    it('should use body-overflow for plugin-created edge resources with denormalized snapshots', async () => {
      const isolatedDb = new Database({ connectionString: 'memory://test/graph-create-resources', logLevel: 'silent' });
  ...
  describe('Undirected Graph', () => {
    ...
    beforeAll(async () => {
      undirectedDb = new Database({ connectionString: 'memory://test/undirected-db', logLevel: 'silent' });
