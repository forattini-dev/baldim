...
export class MLPlugin extends Plugin {
  ...
  constructor(options: MLPluginOptions = {}) {
    ...
    this.cronManager = new IntervalScheduler();
    ...
    if (!this._dependenciesValidated) {
      try {
        ...
        throw new TensorFlowDependencyError(
          'The bundled @tensorflow/tfjs dependency could not be loaded',
...
export { BaseModel } from './ml/base-model.class.js';
export type { BaseModelConfig, BaseModelStats, Normalizer } from './ml/base-model.class.js';
export { RegressionModel } from './ml/regression-model.class.js';
export type { RegressionModelConfig } from './ml/regression-model.class.js';
export { ClassificationModel } from './ml/classification-model.class.js';
export type { ClassificationModelConfig } from './ml/classification-model.class.js';
export { TimeSeriesModel } from './ml/timeseries-model.class.js';
export type { TimeSeriesModelConfig } from './ml/timeseries-model.class.js';
export { NeuralNetworkModel } from './ml/neural-network-model.class.js';
export type { LayerConfig, NeuralNetworkModelConfig } from './ml/neural-network-model.class.js';
export * from './ml.errors.js';
