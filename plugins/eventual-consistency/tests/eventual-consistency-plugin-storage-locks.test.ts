 ...
 *
 * This test suite validates that locks are stored through PluginStorage.
...
describe('EventualConsistencyPlugin - PluginStorage Locks', () => {
  ...
  describe('Lock persistence', () => {
    it('should create lock records during consolidation', async () => {
    ...
    it('should store lock records in the PluginStorage namespace', async () => {
      urls = await database.createResource({
        name: 'urls',
        attributes: {
          id: 'string|optional',
    ...
    it('should list all plugin storage keys including locks', async () => {
      ...
      // List all keys under the PluginStorage namespace.
