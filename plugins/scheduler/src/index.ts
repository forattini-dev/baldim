...
export type { SchedulerErrorDetails } from './errors.js';
...
export type JobAction = (database: Database, context: JobContext, scheduler: SchedulerPlugin) => Promise<unknown>;
...
export interface JobData extends JobConfig {
  enabled: boolean;
  retries: number;
  timeout: number;
  lastRun: Date | null;
...
export interface SchedulerPluginOptions extends CoordinatorConfig {
  timezone?: string;
