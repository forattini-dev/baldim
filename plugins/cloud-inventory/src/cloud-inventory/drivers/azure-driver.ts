...
export class AzureInventoryDriver extends BaseCloudDriver {
  ...
  async *_collectKubernetes(): AsyncGenerator<CloudResource> {
    try {
      const { ContainerServiceClient } = await import('@azure/arm-containerservice') as unknown as {
  ...
  async *_collectStorage(): AsyncGenerator<CloudResource> {
    try {
      const { StorageManagementClient } = await import('@azure/arm-storage') as unknown as {
  ...
  async *_collectCosmosDB(): AsyncGenerator<CloudResource> {
    try {
      const { CosmosDBManagementClient } = await import('@azure/arm-cosmosdb') as unknown as {
  ...
  async *_collectNetwork(): AsyncGenerator<CloudResource> {
    try {
      const { NetworkManagementClient } = await import('@azure/arm-network') as unknown as {
  ...
  async *_collectContainerRegistry(): AsyncGenerator<CloudResource> {
    try {
      const { ContainerRegistryManagementClient } = await import('@azure/arm-containerregistry') as unknown as {
  ...
  async *_collectDNS(): AsyncGenerator<CloudResource> {
    try {
      const { DnsManagementClient } = await import('@azure/arm-dns') as unknown as {
  ...
  async *_collectIdentity(): AsyncGenerator<CloudResource> {
    try {
      const { ManagedServiceIdentityClient } = await import('@azure/arm-msi') as unknown as {
