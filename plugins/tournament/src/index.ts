...
export interface TournamentPluginOptions extends PluginOptions {
  resourceNames?: {
    tournaments?: string;
    matches?: string;
...
export class TournamentPlugin extends Plugin<TournamentPluginOptions> {
  ...
  getFormatMetadata(): FormatMetadata[] {
    return getFormatMetadata() as FormatMetadata[];
  }
