...
export type PuppeteerPluginOptions = PluginOptions & DeepPartial<PuppeteerPluginConfig> & {
  resourceNames?: {
    cookies?: string;
...
export class PuppeteerPlugin extends Plugin {
  ...
  override async onUninstall(_options: UninstallOptions = {}): Promise<void> {
    await this.onStop();
...
export * from './puppeteer/anti-bot-detector.js';
export * from './puppeteer/console-monitor.js';
export * from './puppeteer/cookie-manager.js';
export * from './puppeteer/network-monitor.js';
export * from './puppeteer/performance-manager.js';
export * from './puppeteer/proxy-manager.js';
export * from './puppeteer/stealth-manager.js';
export * from './puppeteer/storage-manager.js';
export * from './puppeteer/webrtc-streams-detector.js';
