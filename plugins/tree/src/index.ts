...
export class TreePlugin extends Plugin<TreePluginOptions> {
  config: TreePluginConfig;
  driver: TreeDriver;
  ...
  override async onInstall(): Promise<void> {
    ...
    this.addDatabaseHook('afterCreateResource', async () => {
      this._installResourceMethods();
    });
  }
  ...
  private _installResourceMethods(): void {
    for (const resource of Object.values(this.database.resources)) {
      ...
      this.extendResource(resource as any, { tree: treeNamespace });
