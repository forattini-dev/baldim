# @baldin/plugin-s3-queue

Durable queues stored through Baldin resources and plugin storage. The plugin
...
Despite its compatibility name, the package works with any Baldin storage
