...
export interface Resource {
  ...
  addHook?(event: string, handler: (data: unknown) => unknown | Promise<unknown>): void;
  removeHook?(event: string, handler: (data: unknown) => unknown | Promise<unknown>): boolean;
}
...
export interface StateMachinePluginContext {
  ...
  getStorage(): any;
  extendResource(resource: Resource, extensions: Record<string, unknown>): void;
  addResourceHook(resource: Resource, event: string, hook: (data: unknown) => unknown | Promise<unknown>): void;
