...
| Plugin catalog | 23 plugin families, 411 TypeScript files | Public plugin SDK, `@baldin/plugin-audit`, and `@baldin/plugin-ttl`; 21 families remain | Partial |
| Installable packages | One all-in-one package | `core`, five storage adapters, `plugin-audit`, and `plugin-ttl` | Partial |
...
| Test suites | 118 core and 176 plugin test files | 15 focused test files, 98 tests plus 4 MinIO contract cases in CI | Partial |
