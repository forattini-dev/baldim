...
| Plugin catalog | 23 plugin families, 411 TypeScript files | Public plugin SDK plus audit, TTL, scheduler, and fulltext packages; 19 families remain | Partial |
| Installable packages | One all-in-one package | `core`, five storage adapters, and four standalone plugins | Partial |
...
| Test suites | 118 core and 176 plugin test files | 18 focused test files, 119 tests plus 4 MinIO contract cases in CI | Partial |
