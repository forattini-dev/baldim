...
| Plugin catalog | 23 plugin families, 411 TypeScript files | Public plugin SDK plus audit, TTL, scheduler, fulltext, and geo packages; 18 families remain | Partial |
| Installable packages | One all-in-one package | `core`, five storage adapters, and five standalone plugins | Partial |
...
| Test suites | 118 core and 176 plugin test files | 19 focused test files, 135 tests plus 4 MinIO contract cases in CI | Partial |
