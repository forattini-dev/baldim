...
| Plugin catalog | 23 plugin families, 411 TypeScript files | Public plugin SDK plus audit, TTL, scheduler, fulltext, geo, and graph packages; 17 families remain | Partial |
| Installable packages | One all-in-one package | `core`, five storage adapters, and six standalone plugins | Partial |
...
| Test suites | 118 core and 176 plugin test files | 21 focused test files, 161 tests plus 4 MinIO contract cases in CI | Partial |
