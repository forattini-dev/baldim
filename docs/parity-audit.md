...
| --- | ---: | --- | --- |
| Source | 558 files, 555 TypeScript | 102 core TypeScript files plus 98 adapter and plugin TypeScript files | Partial |
...
| Test suites | 118 core and 176 plugin test files | 27 focused test files, 252 tests plus 4 MinIO contract cases in CI | Partial |
