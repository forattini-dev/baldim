...
| Plugin catalog | 23 plugin families, 411 TypeScript files | Public plugin SDK plus audit, TTL, and scheduler packages; 20 families remain | Partial |
| Installable packages | One all-in-one package | `core`, five storage adapters, and three standalone plugins | Partial |
...
| Test suites | 118 core and 176 plugin test files | 16 focused test files, 106 tests plus 4 MinIO contract cases in CI | Partial |
