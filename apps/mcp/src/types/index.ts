...
export interface ResourceListPartitionsArgs { resourceName: string }

export interface ResourceListPartitionValuesArgs {
  resourceName: string;
  partitionName: string;
  limit?: number;
}

export interface DbFindOrphanedPartitionsArgs { resourceName?: string }

export interface DbRemoveOrphanedPartitionsArgs {
  resourceName: string;
  dryRun?: boolean;
}
